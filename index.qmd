...
ggplot(data = penguins, aes(x = bill_length_mm, y = bill_depth_mm, color = species)) +
  geom_point(size = 3, alpha = 0.6) +  # Tamaño y transparencia de los puntos
  geom_smooth(method = "lm", se = FALSE, linetype = "dashed", color = "black") +  # Línea de regresión + 
  geom_smooth(aes(group=species, color=species),method = "lm", se = FALSE, linetype = "dashed") +  # Línea de regresión
  ...
  theme(
    ...
    legend.background = element_rect(fill = "lightblue", color = "blue", size = 0.5),  # Fondo y borde de la leyenda
    panel.grid.major = element_line(color = "gray80")  # Líneas de cuadrícula personalizadas
  )
```
...
ggplot(data = penguins, aes(x = species, y = body_mass_g, fill = sex)) +
  ...
  scale_fill_manual(values = c("male" = "#FF6347", "female" = "#4682B4")) +  # Colores personalizados para sexo
  labs(
